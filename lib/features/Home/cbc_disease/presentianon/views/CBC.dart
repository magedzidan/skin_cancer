    ...
    return Form(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: const Text("Blood Testing"),
          centerTitle: true,
        ),
        body: Padding(
                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      /* EntryData("RBC: ", rbc, "PCV: ", pcv, "MCV: ", mcv,_formKey),
                    const SizedBox(height: 20),
                    EntryData("TLC: ", tlc, "PLT: ", plt, "HGB: ", hgb,_formKey),
                    const SizedBox(height: 20),
                    EntryData("MCH:", mch, "RDW:", rdw, "MCHC:", mchc,_formKey),*/
